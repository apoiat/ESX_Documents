...
Config.MenuKey = 182
Config.UseCustomFonts = true
Config.CustomFontFile = "greek"
Config.CustomFontId = "OpenSans"
Config.Locale = "gr"
	...
	["public"] = {
		{
			...
			elements = {
				{ label = "ΗΜΕΡΟΜΗΝΙΑ ΣΥΜΒΑΝΤΟΣ", type = "input", value = "", can_be_emtpy = true },
				{ label = "ΠΕΡΙΕΧΟΜΕΝΟ ΚΑΤΑΘΕΣΗΣ", type = "textarea", value = "", can_be_emtpy = true },
			}
		},
		{
			...
			elements = {
				{ label = "ΠΙΝΑΚΙΔΑ ΟΧΗΜΑΤΟΣ", type = "input", value = "", can_be_emtpy = true },
				{ label = "ΠΡΟΣ ΠΡΟΣΩΠΟ", type = "input", value = "", can_be_emtpy = true },
				{ label = "ΕΝΑΝΤΙ ΠΟΣΟΥ", type = "input", value = "", can_be_empty = true },
